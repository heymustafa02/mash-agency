...
//                     <p className="text-gray-400 text-center">© 2025 <a href="http://mustafa-mallebhari.vercel.app" target="_blank" className="hover:text-gray-200">Mustafa Mallebhari</a>.
...
//                         </a> */}
//                         <a href="https://www.twitter.com/mallebhari_" target="_blank" aria-label="social media">
...
//                         </a>
//                         <a href="https://www.linkedin.com/in/mustafamallebhari" target="_blank" aria-label="social media">
            ...
            <div className="custom-screen">
                <div className="mt-10 py-8 border-t border-gray-800 items-center justify-between sm:flex">
                    <p className="text-gray-400 text-center">
                        © 2025 <a href="http://mustafa-mallebhari.vercel.app" target="_blank" rel="noreferrer noopener" className="hover:text-gray-200">Mustafa Mallebhari</a>.
                        All rights reserved.
                    </p>
                    <div className="flex items-center justify-center gap-x-6 text-gray-500 mt-6 sm:mt-0">
                        {/* <a href="/" target="_blank" aria-label="social media">
                        ...
                        <a href="https://www.twitter.com/mallebhari_" target="_blank" rel="noreferrer noopener" aria-label="social media">
                            <svg className="w-6 h-6 hover:text-gray-200 duration-150" fill="none" viewBox="0 0 48 48">
                                ...
                                <defs><clipPath id="clip0_17_80"><path fill="currentColor" d="M0 0h48v48H0z" /></clipPath></defs>
                            </svg>
                        </a>
                        <a href="https://www.linkedin.com/in/mustafamallebhari" target="_blank" rel="noreferrer noopener" aria-label="social media">
                            <svg className="w-6 h-6 hover:text-gray-200 duration-150" fill="none" viewBox="0 0 48 48">
