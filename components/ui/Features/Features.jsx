...
const Features = () => {
    ...
    const featuresList = [
        ...
        },
        {
            ...
            desc: "Mash uses AI to create personalized emails for each recipient based on their past interactions with the brand."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div id="features" className="custom-screen text-gray-300">
                ...
                >
                    <div className="max-w-xl mx-auto text-center">
                        ...
                        "Start building your online presence with Mash
         
                        </h2>
                        <p className="mt-3">
                        At Mash, we make it easy to create stunning websites that capture attention, engage visitors, and convert leads into loyal customers. With our expertise, we help you track results and grow your business with a website that truly reflects your brand.                        </p>
                    </div>
                </LayoutEffect>
                <LayoutEffect
